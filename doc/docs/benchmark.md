...
![benchmark-5tests.csv.png](benchmark/seqkit_multi_threads/benchmark.5tests.csv.png)

### Tests on different file sizes

Files are generated by replicating Human genome chr1 for N times.

![benchmark.seqkit.files_size.csv.png](benchmark/seqkit_file_size/benchmark.seqkit.files_size.csv.png)
